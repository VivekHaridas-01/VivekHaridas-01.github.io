...
!(function (a, b) {
  ...
  $(document).ready(function () {
    // Hide all project blocks initially
    $(".project").hide();

    // Show the default category (Machine Learning)
    $(".machine-learning").show();

    // Handle click event on menu items
    $(".work-menu a").click(function () {
      // Hide all project blocks
      $(".project").hide();

      // Get the category related to the clicked menu item
      var category = $(this).text().toLowerCase().replace(/ /g, "-");

      // Show the project blocks related to the clicked category
      $("." + category).show();
